...
<div class="min-h-screen flex items-center justify-center p-8 bg-background">
    <div class="w-full max-w-md bg-background-card rounded-lg shadow-md p-8">
      ...
      <div v-if="sessionExpired" class="bg-warning text-text p-3 rounded-md mb-6">
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        ...
        <div class="flex items-center">
          <label class="flex items-center cursor-pointer select-none">
            <input type="checkbox" v-model="rememberMe" class="mr-2 h-4 w-4" />
      ...
      <div class="mt-8 pt-6 border-t border-border">
        ...
        <p class="text-text opacity-80 mb-4">{{ $t('auth.demoUsersDescription') }}</p>
